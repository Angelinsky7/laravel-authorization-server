...
class BeforeOrNull implements Rule, DataAwareRule
{
    ...
    public function passes($attribute, $value)
    {
        ...
        $validator = Validator::make([
            'test' => $value,
            "$this->beforeAttribute" => $this->data[$this->beforeAttribute]
        ], [
            'test' => "before:$this->beforeAttribute",
        ]);
    ...
    {
        return "The :attribute must be a date before $this->beforeAttribute";
    }
